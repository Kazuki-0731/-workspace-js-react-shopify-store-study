...
4.  **Open the source code and start editing!**
    ...
    Open the `shopify-store-study` directory in your code editor of choice and edit `src/pages/index.jsx`. Save your changes and the browser will update in real time!
